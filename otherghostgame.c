...
#include<string.h>
#include<ctype.h>
int determineScenario(int playerChoice, int scenario, int ending);
int determineEnding(int scenario, int playerChoice, int ending);
int scanPlayerChoice(void);
int main()
{
	int start=0, playerChoice, ending, scenario, peaceScenario=0, altScenario, deadEndScenario, tryAgain;
	...
	while(start == 1){
	    ...
	    {
	    	system("cls");
    		scenario=determineScenario(playerChoice, scenario, ending);
